  ...
  return (
    <ul className="timeline timeline-vertical">
      ...
      <li>
        ...
        <div className="timeline-end timeline-box">
          <ProductCard
            title={"Q4 2024: Exclusive Raffle Participation System"}
            descriptionOne="Raffle System for Ticket Holders: Implement a system that allows users to participate in exclusive raffles simply by holding a ticket or having hosted an event with us."
